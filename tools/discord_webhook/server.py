...
valid = "<>АБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯабвгдеёжзийклмнопрстуфхцчшщъыьэюяABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-._~:/?#[]@!$&'()*+,;= "
...
def trigger(channel, message):
    ...
    if channel == "ooc":
        ...
        requests.post(round_webhook, data=data)
        return message
    else:
